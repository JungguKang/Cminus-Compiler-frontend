...
{
       0,    40,    40,    43,    52,    54,    55,    57,    62,    67,
      68,    67,    75,    76,    75,    84,    84,    89,    89,    95,
     101,   102,   105,   115,   117,   122,   122,   129,   134,   134,
     142,   148,   159,   161,   171,   173,   174,   175,   176,   177,
     179,   180,   182,   187,   194,   200,   202,   207,   212,   214,
     218,   218,   225,   230,   232,   233,   234,   235,   236,   237,
     239,   245,   251,   253,   259,   265,   267,   268,   269,   270,
     275,   275,   282,   283,   285,   295
};
#endif
...
static const char *const yytname[] =
{
  ...
  "OVER", "LPAREN", "RPAREN", "SEMI", "LBRACE", "RBRACE", "LCURLY",
  "RCURLY", "COMMA", "ERROR", "NO_ELSE", "$accept", "program", "decl_seq",
  "decl", "var_decl", "$@1", "$@2", "$@3", "$@4", "fun_decl", "$@5", "$@6",
  "fun_decl2", "params", "param_list", "param", "$@7", "$@8", "comp_stmt",
  "local_decls", "stmt_list", "stmt", "exp_stmt", "select_stmt",
  "iter_stmt", "return_stmt", "exp", "var", "$@9", "simple_exp", "relop",
  "add_exp", "term", "factor", "call", "$@10", "args", "arg_list", YY_NULLPTR
};
#endif
...
{
      56,   -10,    -5,    22,    56,  -111,  -111,  -111,    -2,     9,
    -111,  -111,  -111,    -6,     2,  -111,    13,     2,    24,    58,
    -111,    63,  -111,  -111,    31,    46,    51,    47,  -111,  -111,
      52,    50,    54,    53,    60,    55,    59,    57,    61,  -111,
    -111,    46,  -111,    64,  -111,    65,    66,    62,  -111,  -111,
    -111,    68,    75,  -111,     1,    69,    70,    67,    73,    17,
     -13,  -111,    -7,  -111,  -111,  -111,  -111,  -111,  -111,  -111,
    -111,    72,    74,  -111,    30,    45,  -111,  -111,    -7,    -7,
    -111,    76,    77,    79,    80,  -111,    -7,  -111,  -111,  -111,
    -111,  -111,  -111,    -7,    -7,    -7,    -7,    -7,    81,    82,
    -111,    -7,    -7,  -111,  -111,  -111,    45,    45,    49,  -111,
    -111,     8,     8,    71,  -111,    83,    78,    89,  -111,  -111,
    -111,    -7,     8,  -111,  -111
};
...
{
       0,     0,     0,     0,     2,     4,     5,     6,     9,    12,
       1,     3,     7,     0,     0,     8,     0,     0,     0,     0,
      16,     0,    18,    10,     0,    21,     0,    20,    23,    13,
       0,    24,    27,     0,     0,     0,     0,     0,     0,    32,
      19,     0,    22,     0,    11,     0,     0,    34,    14,    26,
      29,     0,     0,    31,     0,     9,    12,     0,     0,     0,
      49,    69,     0,    41,    30,    36,    33,    35,    37,    38,
      39,     0,    67,    48,    53,    62,    65,    68,     0,     0,
      45,     0,     0,     0,     0,    40,     0,    58,    59,    54,
      55,    56,    57,     0,     0,     0,     0,     0,     0,     0,
      46,     0,    73,    66,    47,    67,    60,    61,    52,    63,
      64,     0,     0,     0,    75,     0,    72,    42,    44,    51,
      71,     0,     0,    74,    43
};
...
{
    -111,  -111,  -111,    92,    84,  -111,  -111,  -111,  -111,  -111,
    -111,  -111,    87,  -111,  -111,    85,  -111,  -111,    88,  -111,
    -111,  -110,  -111,  -111,  -111,  -111,   -59,   -37,  -111,  -111,
    -111,    10,   -18,   -19,  -111,  -111,  -111,  -111
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     3,     4,     5,     6,    13,    30,    16,    35,     7,
      14,    17,    20,    26,    27,    28,    37,    38,    65,    47,
      54,    66,    67,    68,    69,    70,    71,    72,    82,    73,
      95,    74,    75,    76,    77,    83,   115,   116
};
...
{
      81,   117,   118,    84,    57,     8,    58,    59,    60,    61,
       9,    57,   124,    58,    59,   -70,    60,    61,   -50,    98,
      99,    62,    10,    60,    61,    18,   -15,   104,    12,    62,
      19,    63,    60,    61,    39,    64,    62,   -17,    63,    15,
      23,    39,   113,   114,    21,    62,    31,    80,    87,    88,
      89,    90,    91,    92,    93,    94,   105,   105,   105,   105,
     105,    32,   123,     1,     2,    24,    25,    24,    41,    51,
      52,    96,    97,    93,    94,   106,   107,   109,   110,    29,
      33,   -25,    34,    55,    36,   -28,    39,    43,    45,    44,
      56,    86,    46,   122,    48,    78,    11,    49,    50,    12,
      15,    79,    85,   119,    22,   108,   100,   102,   101,   103,
     111,   112,   120,   121,     0,     0,     0,     0,     0,    42,
...
{
      59,   111,   112,    62,     3,    15,     5,     6,    15,    16,
      15,     3,   122,     5,     6,    28,    15,    16,    31,    78,
      79,    28,     0,    15,    16,    31,    28,    86,    30,    28,
      28,    30,    15,    16,    33,    34,    28,    28,    30,    30,
      16,    33,   101,   102,    31,    28,    15,    30,    18,    19,
      20,    21,    22,    23,    24,    25,    93,    94,    95,    96,
      97,    15,   121,     7,     8,     7,     8,     7,     8,     7,
       8,    26,    27,    24,    25,    93,    94,    96,    97,    16,
      29,    31,    35,    15,    32,    31,    33,    32,    31,    30,
      15,    17,    31,     4,    30,    28,     4,    32,    32,    30,
      30,    28,    30,    32,    17,    95,    30,    28,    31,    29,
      29,    29,    29,    35,    -1,    -1,    -1,    -1,    -1,    34,
...
{
       0,     7,     8,    39,    40,    41,    42,    47,    15,    15,
       0,    41,    30,    43,    48,    30,    45,    49,    31,    28,
      50,    31,    50,    16,     7,     8,    51,    52,    53,    16,
      44,    15,    15,    29,    35,    46,    32,    54,    55,    33,
      56,     8,    53,    32,    30,    31,    31,    57,    30,    32,
      32,     7,     8,    42,    58,    15,    15,     3,     5,     6,
      15,    16,    28,    30,    34,    56,    59,    60,    61,    62,
      63,    64,    65,    67,    69,    70,    71,    72,    28,    28,
      30,    64,    66,    73,    64,    30,    17,    18,    19,    20,
      21,    22,    23,    24,    25,    68,    26,    27,    64,    64,
      30,    31,    28,    29,    64,    65,    70,    70,    69,    71,
      71,    29,    29,    64,    64,    74,    75,    59,    59,    32,
      29,    35,     4,    64,    59
};
...
static const yytype_uint8 yyr1[] =
{
      ...
      44,    42,    45,    46,    42,    48,    47,    49,    47,    50,
      51,    51,    52,    52,    53,    54,    53,    53,    55,    53,
...
#line 58 "cminus.y" /* yacc.c:1646  */
    { (yyval) = newStmtNode(VarK);
				  (yyval)->attr.name = copyString(currString);
				  (yyval)->type = Integer;
				}
...
#line 67 "cminus.y" /* yacc.c:1646  */
    { savedName = copyString(currString); }
...
#line 84 "cminus.y" /* yacc.c:1646  */
    { savedFuncName = copyString(currString); }
...
#line 85 "cminus.y" /* yacc.c:1646  */
    { (yyval) = (yyvsp[0]);
				  (yyval)->attr.name = copyString(savedFuncName);
				  (yyval)->type = Integer;
				}
...
#line 218 "cminus.y" /* yacc.c:1646  */
    { savedIdName[savedId++] = copyString(currString); }
#line 1753 "y.tab.c" /* yacc.c:1646  */
    break;

  case 51:
#line 220 "cminus.y" /* yacc.c:1646  */
    { (yyval) = newExpNode(IdK2);
					(yyval)->attr.name = copyString(savedIdName[--savedId]);
					(yyval)->child[0] = (yyvsp[-1]);
				}
...
#line 275 "cminus.y" /* yacc.c:1646  */
    { savedCallName[savedCall++] = copyString(currString);}
...
#line 277 "cminus.y" /* yacc.c:1646  */
    { (yyval) = newStmtNode(CallK); 
				 (yyval)->attr.name = copyString(savedCallName[--savedCall]);
				 (yyval)->child[0] = (yyvsp[-1]);
				}
